// ==========================================
// TỰ ĐỘNG KHỞI TẠO PACKAGE.JSON (GOM CHUNG VÀO ĐÂY)
// ==========================================
if (process.env.AUTO_SETUP !== 'true') {
    const fs = require('fs');
    
    // Tự sinh file package.json để Render tự biết cài thư viện
    const packageJson = {
    ...
    // Đánh dấu đã setup xong để chạy tiếp phần bot
    process.env.AUTO_SETUP = 'true';
}

// ==========================================
// CODE CHÍNH CỦA BOT DISCORD
// ==========================================
const { Client, GatewayIntentBits, REST, Routes, SlashCommandBuilder } = require('discord.js');
const axios = require('axios');
const http = require('http');

// Tạo web server mini để Render giữ bot online 24/7
